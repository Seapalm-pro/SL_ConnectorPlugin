...
public abstract class SubCommand implements TabExecutor {
    protected final Bukkitslconnector plugin;
    ...
    public SubCommand(Bukkitslconnector plugin, String usage, String permission, String... aliases) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (subCommand != null) {
            if (sender.hasPermission(subCommand.getPermission())) {
                if (subCommand.onCommand(sender, command, label + " " + args[0],
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        for (Map.Entry<String, SubCommand> e : subCommands.entrySet()) {
            if (e.getKey().startsWith(args[0].toLowerCase(Locale.ROOT))
    ...
    public Bukkitslconnector getPlugin() {
        return plugin;
    }
