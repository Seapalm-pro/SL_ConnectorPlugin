...
public abstract class BridgeCommon<P extends slconnector<R>, R> {
    private static final int VERSION = 2;
    protected final P plugin;

    protected final Map<String, PlayerInfo> playerInfoMap = new HashMap<>();
    protected final Cache<Long, ResponseHandler<?>> responses = CacheBuilder.newBuilder()
            .expireAfterWrite(1, TimeUnit.MINUTES).build();
    protected final Cache<Long, Consumer<String>[]> consumers = CacheBuilder.newBuilder()
     ...
     * @return A future about whether the player could be teleported
     */
    public abstract CompletableFuture<Boolean> teleport(String playerName, LocationInfo location,
     ...
     * @return A future about whether the player could be teleported
     */
    public abstract CompletableFuture<Boolean> teleport(String playerName, String serverName, String worldName,
            Consumer<String>... consumer);
     ...
     * @return A future about whether the player could be teleported
     */
    public abstract CompletableFuture<Boolean> teleport(R player, String serverName, String worldName,
            Consumer<String>... consumer);
     ...
     * @return A future about whether the player could be teleported
     */
    public abstract CompletableFuture<Boolean> teleport(String playerName, String targetName,
            Consumer<String>... consumer);
     ...
     */
    public CompletableFuture<Boolean> runServerConsoleCommand(String server, String command,
            Consumer<String>... consumer) {
     ...
     * @return A future for whether the command was run successfully
     */
    public CompletableFuture<Boolean> runProxyConsoleCommand(String proxy, String command,
            Consumer<String>... consumer) {
        CompletableFuture<Boolean> future = new CompletableFuture<>();
        ByteArrayDataOutput out = ByteStreams.newDataOutput();
        long id = RANDOM.nextLong();
        ...
        public static BridgeMessage fromByteArray(byte[] messageData) throws VersionMismatchException {
            ...
            if (version < VERSION) {
                throw new VersionMismatchException(version, VERSION,
                        "Received bridge message from an outdated version! Please update the sending plugin!");
            } else if (version > VERSION) {
                throw new VersionMismatchException(version, VERSION,
                        "Received bridge message with a newer version! Please update this plugin!");
            }
     ...
     * 
     * @return Whether the player is currently teleporting with slconnector
     */
