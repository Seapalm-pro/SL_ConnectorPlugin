...
public class PluginConfig {
    ...
    public PluginConfig(Velocityslconnector plugin, File configFile) {
        this(plugin, configFile, configFile.getName());
    }

    public PluginConfig(Velocityslconnector plugin, File configFile, String defaultFile) {
        this.plugin = plugin;
            ...
            if (defaultFile != null) {
                defaultConfig = YamlConfigurationLoader.builder()
                        ...
                        .source(() -> new BufferedReader(
                                new InputStreamReader(plugin.getResourceAsStream(defaultFile))))
                        .build().load();
                if (config.empty()) {
